...
def evaluate_adv_samples(model, tokenizer, tokenizer_surr, adv_log_coeffs, clean_texts, labels,
    ...
    # print(len(adv_log_coeffs['premise']), len(labels), len(clean_texts['premise']))
    # print(adv_log_coeffs, labels, clean_texts, sep='---')
    assert len(adv_log_coeffs['premise']) == len(adv_log_coeffs['hypothesis']) == len(labels) == len(clean_texts['premise']) == len(clean_texts['hypothesis'])
